...
## Система классовых умений. 3 слота (Q / E / F), каждый с отдельным cooldown.
## E разделяет action с interact; контекст решается через _unhandled_input + set_input_as_handled().
## [br]
