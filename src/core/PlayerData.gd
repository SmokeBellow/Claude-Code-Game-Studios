...
## Доступные очки навыков (тратятся через SkillTree.spend_point).
var skill_points: int = 0

## Вложенные очки по веткам: branch_key → кол-во вложенных очков.
var spent_points: Dictionary = {}

# ---------------------------------------------------------------------------
# Имя героя
# ---------------------------------------------------------------------------

## Имя героя, введённое на экране новой игры.
